...
basedir = fullfile('/asl/rtp/rtp_cris_ccast_lowres/clear', ...
                   int2str(year));
...
eval_str = ['save ~/testoutput/data/stats/cris/rtp_cris_lowres_rad_'  int2str(year) ...
            '_clear' sDescriptor '_trop robs rcal bias_std *_mean count '];
