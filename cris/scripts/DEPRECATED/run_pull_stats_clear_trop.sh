...
# sbatch options
#SBATCH --job-name=RUN_LR_PS_CLR_TROP
# partition = dev/batch
...
#SBATCH -o /home/sbuczko1/logs/sbatch/run_cris_pull_stats_clr_trop-%A_%a.out
#SBATCH -e /home/sbuczko1/logs/sbatch/run_cris_pull_stats_clr_trop-%A_%a.err
...
$MATLAB $MATOPT -r "addpath('~/git/pull_stats/cris','~/git/rtp_prod2/cris/scripts'); run_pull_stats_clear_trop(); exit"
