function file_names = rtpwrite_12(rtp_outfile,head,hattr,prof,pattr)
...
% $$$ tmpfile1 = mktemp();
% $$$ tmpfile2 = mktemp();
[sID, scratchpath] = genscratchpath();
tmpfile1 = sprintf('%s/tmp1_%s.rtp', scratchpath,sID);
tmpfile2 = sprintf('%s/tmp2_%s.rtp', scratchpath,sID);
