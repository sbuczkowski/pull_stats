function pull_stats_airixcal_clear(year, filter, cfg);
...
robs = zeros(ndays, nlatbins, nchans, 'single');
rclr = zeros(ndays, nlatbins, nchans, 'single');
rcldy = zeros(ndays, nlatbins, nchans, 'single');
rcldybias_std = zeros(ndays, nlatbins, nchans, 'single');
rclrbias_std = zeros(ndays, nlatbins, nchans, 'single');

lat_mean = zeros(ndays, nlatbins, 'single');
lon_mean = zeros(ndays, nlatbins, 'single');
solzen_mean = zeros(ndays, nlatbins, 'single');
rtime_mean = zeros(ndays, nlatbins, 'double'); 
count = zeros(ndays, nlatbins, nchans, 'uint16');
tcc_mean = zeros(ndays, nlatbins, 'single');
stemp_mean = zeros(ndays, nlatbins, 'single');
ptemp_mean = zeros(ndays, nlatbins, nlevs, 'single');
gas1_mean = zeros(ndays, nlatbins, nlevs, 'single');
gas3_mean = zeros(ndays, nlatbins, nlevs, 'single');
spres_mean = zeros(ndays, nlatbins, 'single');
nlevs_mean = zeros(ndays, nlatbins, 'uint8');
iudef4_mean = zeros(ndays, nlatbins, 'uint8');
mmwater_mean = zeros(ndays, nlatbins, 'double');
satzen_mean = zeros(ndays, nlatbins, 'single');
plevs_mean = zeros(ndays, nlatbins, nlevs, 'uint8');
